...
/* endpoint extension control register register */
...
#define XAS_CAM_TVMAC_EN	BIT(0)
#define XAS_CAM_TVVLAN_EN	BIT(1)
#define XAS_CAM_UNTAG_EN	BIT(2)
#define XAS_CAM_TAG_EN		BIT(3)
