 ...
 *
 * $Id: trdp_if.c 1841 2019-02-11 14:38:42Z s-bender $
 *
    ...
    if (ret == TRDP_NO_ERR)
    {
            ...
            && (pNewElement != NULL))
        {
            ...
            else
            {
                ...
                nextTime.tv_sec += 2 + comId % 128 / 100u;              
                nextTime.tv_usec = comId % 100 * 10000u;
...
// tlc_process for recv, delete SendQueued

EXT_DECL TRDP_ERR_T tlc_process_recv (
    TRDP_APP_SESSION_T  appHandle,
    TRDP_FDS_T          *pRfds,
    INT32               *pCount)
{
...
// tlc_process for recv, delete RecvQueued

EXT_DECL TRDP_ERR_T tlc_process_send (
    TRDP_APP_SESSION_T  appHandle)
{
    TRDP_ERR_T  result = TRDP_NO_ERR;
    TRDP_ERR_T  err;
