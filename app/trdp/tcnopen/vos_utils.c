 ...
 *
 * $Id: vos_utils.c 1831 2019-01-28 13:51:11Z bloehr $
 *
...
/**********************************************************************************************************************/
/** Init ptp file descripter. (MODIFIED)
 *
 *  @retval        VOS_INTEGRATION_ERR or VOS_NO_ERR
 */

static VOS_ERR_T vos_initPtpFd(void)
{
#ifdef CLOCK_PTP
    ptp_fd = open("/dev/ptp0", O_RDONLY);
    if (ptp_fd < 0)
    {
        vos_printLogStr(VOS_LOG_ERROR, "ERROR PTP Open failed\n");
